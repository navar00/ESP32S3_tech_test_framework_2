...
- Métodos públicos abstraen completamente la librería subyacente — el caller jamás incluye `TFT_eSPI.h`, `Adafruit_NeoPixel.h`, `Bluepad32.h` directamente fuera del HAL.
...
- `InputHAL` (Bluepad32): implementar SIEMPRE stubs de callbacks — callbacks nulos crashean.
